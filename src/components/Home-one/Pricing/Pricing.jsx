...
function Pricing() {
  ...
  const CardData = [
    {
      id: 1,
      title: "Basic",
      text: "Lorem ipsum dolor sit amet consectetur erat ipsum non.",
      price1: "$199",
      price2: "$179",
      time: "/month",
      features: [
  ...
  return (
    <>
      ...
      <section className="w-full relative h-[39rem] bg-pricing-bg bg-cover bg-center">
      ...
      <section className="w-full px-5 py-20">
        ...
        <div className="flex items-center justify-center">
          ...
          >
            <h1
              className={`uppercase font-sans font-medium  duration-500 ${
                isSwitch ? "text-main-colo-1" : "text-main-colo-2 font-bold"
              }`}
            >
              Monthly
            </h1>
            <div
              className="w-20 h-10 bg-main-colo-1 rounded-full flex items-center p-1 transition-all duration-500  cursor-pointer"
              onClick={() => setIsSwitch(!isSwitch)}
            >
              <div
                className={`w-8 h-8 rounded-full bg-main-colo-2 transition-all duration-500  ${
                  isSwitch ? "translate-x-10" : ""
                }`}
              ></div>
            </div>
            <h1
              className={`uppercase font-sans font-medium duration-500 ${
                isSwitch ? " text-main-colo-2 font-bold" : "text-main-colo-1"
              }`}
            >
              Yearly
            </h1>
        ...
        {/* Cards start */}
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 items-center justify-items-center">
          {CardData.map((data) => (
            <div
              className={`shadow-2xl  p-12 flex flex-col gap-8 ${
                data.title === "Premium"
                  ? "bg-main-colo-1 text-main-colo-3 border-t-8 border-main-colo-2 rounded-md"
                  : ""
              }`}
              key={data.id}
              data-aos="fade-up"
            >
              <h1 className="text-2xl font-serif font-medium">{data.title}</h1>
              <p className="text-gray-500 font-sans font-medium">{data.text}</p>
              <h1 className="text-4xl font-sans font-medium duration-500">
                {isSwitch ? data.price2 : data.price1}
                <sub className="text-sm text-gray-600">{data.time}</sub>
              </h1>
              <ul className="flex flex-col gap-5">
                {data.features.map((values, index) => (
                  <li
                    className="flex gap-5 text-gray-400 font-sans font-medium"
                    key={index}
                  >
                    <svg
                      className="w-6 h-6 text-main-colo-2 "
                      aria-hidden="true"
              ...
              <button
                className={`w-full font-medium px-6 py-3  rounded-md hover:scale-95 duration-300 ${
                  data.title === "Premium"
                    ? "bg-main-colo-2 text-main-colo-1"
      ...
      <section className="px-5 w-full py-20">
        ...
        <div className="text-center">
          <h1
            data-aos="fade-up"
            className="text-main-colo-1 text-2xl md:text-3xl lg:text-5xl font-sans font-medium duration-300"
          >
            Pricing comparison
          </h1>
          <p data-aos="fade-up" className="text-gray-400 font-sans my-5">
        ...
        {/* laptop table start */}
        <div className="px-5 hidden md:block w-full mt-20">
          <table className="w-full border-collapse " data-aos="fade-up">
            <thead>
              <tr className="grid grid-cols-4">
                <th className="h-full p-4"></th>
                <th className="flex flex-col h-full p-4">
                  <span className="text-lg">Basic plan</span>
                  <span className="text-2xl font-sans">
                    $199
                    <sub className="text-sm text-gray-600 font-normal">
                      / month
                    </sub>
                  </span>
                  <span className="text-gray-500 font-sans font-normal">
                    No credit card required.
                  </span>
                </th>
                <th className="flex flex-col h-full p-4 bg-main-colo-1 text-white rounded-t-lg">
                  <span className="text-lg">Starter plan</span>
                  <span className="text-2xl font-sans">
                    $299
                    <sub className="text-sm text-gray-600 font-normal">
                      / month
                ...
                <th className="flex flex-col h-full p-4">
                  <span className="text-lg">Platinum plan</span>
                  <span className="text-2xl font-sans">
                    $399
                    <sub className="text-sm text-gray-600 font-normal">
                      / month
            ...
            <tbody className="">
              <tr className="grid grid-cols-4  justify-items-center h-16 bg-main-colo-3">
                <td className="h-full  font-sans font-medium flex items-center justify-start ">
                  Access to 30+ top courses
                </td>
                <td className="h-full flex items-center justify-start">
                  <svg
                    className="w-6 h-6 text-main-colo-1"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                <td className="bg-main-colo-1 w-full  h-full flex items-center justify-center">
                  <svg
                    className="w-6 h-6 text-main-colo-2"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <tr className="grid grid-cols-4 items-center justify-items-center h-16">
                <td className="h-full  font-sans font-medium flex items-center justify-start">
                  Certification prep
                </td>
                <td className="h-full flex items-center justify-start">
              ...
              <tr className="grid grid-cols-4 items-center justify-items-center h-16 bg-main-colo-3">
                <td className="h-full   font-sans font-medium flex items-center justify-start">
                  Customizable content
                </td>
                <td className="h-full flex items-center justify-start">
              ...
              <tr className="grid grid-cols-4 items-center justify-items-center h-16">
                <td className="  font-sans font-medium flex items-center justify-start">
                  AI-powered coding exercises
                </td>
                <td className="">
                  <svg
              ...
              <tr className="grid grid-cols-4 items-center justify-items-center h-16">
                ...
                <td className="bg-main-colo-1 w-full flex items-center justify-center h-full  rounded-b-lg">
                  <svg
                    className="w-6 h-6 text-main-colo-2"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <table className="w-full" data-aos="fade-up">
            <thead>
              <tr className="grid grid-cols-3">
                <th className="flex flex-col h-full p-3">
                ...
                <th className="flex flex-col h-full p-3 bg-main-colo-1 text-white rounded-t-lg">
                  <span className="">Starter plan</span>
                  <span className=" font-sans">
                    $299
                    <sub className="text-sm text-gray-600 font-normal">
                      / month
            ...
            <tbody>
              <tr className="flex flex-col items-center justify-center gap-3 p-4 bg-main-colo-3">
                <td className="text-lg font-sans font-medium">
                  Access to 30+ top courses
                </td>
              ...
              <tr className="flex flex-col items-center justify-center gap-3 p-4 ">
                <td className="text-lg font-sans font-medium">
                  Certification prep
                </td>
                <div className="flex items-center justify-around w-full">
      ...
      {/* FAQ section start */}
      <section className="px-5 w-full bg-main-colo-3 py-20">
        {/* Content box start */}
        <div
      ...
      {/* Testimonial Start */}
      <section className="px-5 w-full  py-16 grid grid-cols-1 place-items-center">
        <div
